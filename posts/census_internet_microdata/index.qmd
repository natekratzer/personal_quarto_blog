...
date: '2020-09-13'
categories: [R, Census, Internet, Policy]
toc: true
image: "featured.png"
---
...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 500, group_vars = c(YEAR, poverty))
...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 500, group_vars = c(YEAR, age))
...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 500, group_vars = c(YEAR, metro))
